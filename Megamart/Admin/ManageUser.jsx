...
function ManageUser() {
  ...
  async function saveEdit(e) {
    ...
    // Check for duplicate email (username) and mobile number
    const duplicateEmail = users.some(
      (u) => u.username === editForm.username && u._id !== editingUser._id
    );
    if (duplicateEmail) {
    ...
    const duplicateMobile = users.some(
      (u) => u.mobilenumber === editForm.mobilenumber && u._id !== editingUser._id
    );
    if (duplicateMobile) {
      alert("This mobile number is already used by another user.");
      return;
    }
    if (!isValidEmail(editForm.username)) {
