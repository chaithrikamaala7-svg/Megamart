...
function AddProduct() {
  ...
  const handleImageChange = (e) => {
    ...
    if (!file) { setImageFile(null); setPreviewUrl("");
    ...
    <div className="add-product-page">
      <div className="add-product-container">
        ...
        <div className="form-group">
          ...
          <button type="submit" className="btn-submit" disabled={submitting}>{submitting ? (isEditMode ? "Updating..." : "Adding...") : isEditMode ? "Update" : "Add"}</button>
        </form>
      </div>
    </div>
  );
