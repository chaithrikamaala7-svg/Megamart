  ...
  return (
    <header className="sheader" style={{ background: '#fff', borderBottom: '1px solid #eee' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '24px 40px 0 40px' }}>
        <div style={{ fontSize: '2.5rem', color: '#e53935', fontWeight: 'bold', fontFamily: 'sans-serif', letterSpacing: '1px' }}>megamart</div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ position: 'relative' }}>
            ...
            />
            <Search style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', color: '#888' }} size={20} />
          </div>
      ...
      <nav style={{ background: '#f7f7f7', padding: '12px 40px', display: 'flex', justifyContent: 'center', gap: '40px', fontSize: '1.1rem', fontWeight: '500', color: '#333' }}>
        {navItems.map((item) => (
